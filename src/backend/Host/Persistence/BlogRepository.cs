...
namespace ZLBlog.Persistence
{
     public class BlogRepository
     {
          ...
          public async Task<PagedList<Blog>> GetPopularBlogsAsync(int skip = 0, int count = 12, bool includeDeletedItem = false)
          {
               return await _context.GetPopularBlogsAsync(skip, count, includeDeletedItem);
          }
