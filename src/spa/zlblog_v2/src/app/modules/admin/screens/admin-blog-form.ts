...
// components
import { AdminBlogImageDialog } from '../components/admin-blog-image-dialog';
    ...
    <form [formGroup]="form">
      ...
      <div class="mb-2 col-10"> 
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" formControlName="isPopular">
          <label class="form-check-label">Popular Post</label>
        </div>
      </div>
